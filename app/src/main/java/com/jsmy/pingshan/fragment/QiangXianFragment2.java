...
import com.jsmy.pingshan.adapter.QiangXianFrament2Adapter;
...
public class QiangXianFragment2 extends BaseFragment {
    ...
    private QiangXianFrament2Adapter adapter;
    private List<QiangianFrament2Bean.DataBean.ListBean> list;
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_QXLL_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, QiangianFrament2Bean.class).getData().getList();
                    pushData();
                    markerPoit();
                } else {
//                    pushPoit(104.054616, 28.707722);
    ...
    private void initRecycer() {
        handler = new Handler();
        adapter = new QiangXianFrament2Adapter((DingWeiTongJiActivity) getActivity());
...
//        pushPoit(104.054616, 28.707722);
    ...
    private View getWindowView(String mc, String yl) {
        ...
        tvTitle.setText(mc + "：" + yl + "人");
        return view;
    }

    public void getData() {
        NetWork.getQxlllist("1", QiangXianFragment2.this);
    }
