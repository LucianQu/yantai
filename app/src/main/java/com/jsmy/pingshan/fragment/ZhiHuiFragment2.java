...
import com.jsmy.pingshan.adapter.ZhiHuiFragment2Adapter;
...
public class ZhiHuiFragment2 extends BaseFragment {
    ...
    private ZhiHuiFragment2Adapter adapter;
    private List<ZhiHuiFrament2Bean.DataBean.ListBean> list;
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_ZHRYS_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, ZhiHuiFrament2Bean.class).getData().getList();
                    pushData();
                    markerPoit();
                } else {
//                    pushPoit(104.054616, 28.707722);
    ...
    private void initRecycer() {
        handler = new Handler();
        adapter = new ZhiHuiFragment2Adapter((DingWeiTongJiActivity) getActivity());
...
//        pushPoit(104.054616, 28.707722);
    ...
    public void getData() {
        NetWork.getZhryslist("1", ZhiHuiFragment2.this);
    }
