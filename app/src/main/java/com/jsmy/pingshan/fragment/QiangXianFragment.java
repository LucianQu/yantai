...
public class QiangXianFragment extends BaseFragment {
    ...
    private QiangXianFragmentAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_qiang_xian, null);
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_QXLL_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, QiangianFramentBean.class).getData().getList();
                    adapter = new QiangXianFragmentAdapter((DingWeiTongJiActivity) getActivity(), list);
...
//        option.setWifiValidTime(5*60*1000);
    ...
    private void pushOverlay(LatLng latLng, String mc, String yl) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = 0; j < list.get(i).getList().size(); j++) {
                ...
                pushOverlay(new LatLng(Double.parseDouble(list.get(i).getList().get(j).getCwzy()),
                        ...
                        list.get(i).getList().get(j).getQxrs());
...
//            pushOverlay(new LatLng(listLatLng.get(i).latitude, listLatLng.get(i).longitude), "昌平镇", "5人");
...
//            mBaiduMap.addOverlay(new PolylineOptions().width(10).color(0xAAFF0000).points(listLatLng));
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                View view = getWindowView(bundle.getString("mc"), bundle.getString("yl"));
                InfoWindow infoWindow = new InfoWindow(view, latLng, UtilsTools.dip2px(getActivity(), 30.0f));
    ...
    private View getWindowView(String mc, String yl) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_zhihui, null);
        TextView tvTitle = (TextView) view.findViewById(R.id.tv_title);
        tvTitle.setText(mc + "：" + yl);
        return view;
    }

    public void getData() {
        NetWork.getQxlllist("1", QiangXianFragment.this);
    }

    private void pushData() {
//        list = new ArrayList<>();
//        List<QiangianFramentBean.DataBean.ListBeanX.ListBean> childList = new ArrayList<>();
//        childList.add(new QiangianFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new QiangianFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new QiangianFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new QiangianFramentBean.DataBean.ListBeanX.ListBean());
//        List<QiangianFramentBean.DataBean.ListBeanX> groupList = new ArrayList<>();
//        groupList.add(new QiangianFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new QiangianFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new QiangianFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new QiangianFramentBean.DataBean.ListBeanX(childList));
