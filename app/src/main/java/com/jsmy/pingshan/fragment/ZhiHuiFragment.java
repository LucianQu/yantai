...
import com.jsmy.pingshan.adapter.ZhiHuiFragmentAdapter;
...
public class ZhiHuiFragment extends BaseFragment {
    ...
    private ZhiHuiFragmentAdapter adapter;
    private List<ZhiHuiFramentBean.DataBean.ListBeanX> list;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_zhi_hui, null);
        unbinder = ButterKnife.bind(this, view);

        changeBtnColor(2);
        initBaiduMap();
        NetWork.getZhryslist("1", this);
        return view;
    }
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_ZHRYS_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, ZhiHuiFramentBean.class).getData().getList();
                    adapter = new ZhiHuiFragmentAdapter((DingWeiTongJiActivity) getActivity(), list);
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = 0; j < list.get(i).getList().size(); j++) {
                ...
                pushOverlay(new LatLng(Double.parseDouble(list.get(i).getList().get(j).getCwzy()),
                        ...
                        list.get(i).getList().get(j).getZhrys());
...
//        list = new ArrayList<>();
//        List<ZhiHuiFramentBean.DataBean.ListBeanX.ListBean> childList = new ArrayList<>();
//        childList.add(new ZhiHuiFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new ZhiHuiFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new ZhiHuiFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new ZhiHuiFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new ZhiHuiFramentBean.DataBean.ListBeanX.ListBean());
//        List<ZhiHuiFramentBean.DataBean.ListBeanX> groupList = new ArrayList<>();
//        groupList.add(new ZhiHuiFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new ZhiHuiFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new ZhiHuiFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new ZhiHuiFramentBean.DataBean.ListBeanX(childList));
...
//        myExpand.setAdapter(adapter);
    ...
    public void getData() {
        NetWork.getZhryslist("1", ZhiHuiFragment.this);
    }
