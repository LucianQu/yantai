...
import com.jsmy.pingshan.adapter.KuCunFragmentAdapter;
import com.jsmy.pingshan.adapter.QiangXianFragmentAdapter;
...
public class KuCunFragment extends BaseFragment {
    ...
    private KuCunFragmentAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_ku_cun, null);
        unbinder = ButterKnife.bind(this, view);
        changeBtnColor(2);
        initBaiduMap();
        NetWork.getKcwzlist("1", this);
        return view;
    }
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_KCWZ_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, KuCunFramentBean.class).getData().getList();
                    adapter = new KuCunFragmentAdapter((DingWeiTongJiActivity) getActivity(), list);
...
//        option.setWifiValidTime(5*60*1000);
    ...
    private void pushOverlay(LatLng latLng, String title, String yuyi, String yuxie, String sdt, String tc) {
        ...
        bundle.putString("yuyi", yuyi);
        bundle.putString("yuxie", yuxie);
...
//        pushPoit(104.054616, 28.707722);
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = 0; j < list.get(i).getList().size(); j++) {
                if ("".equals(list.get(i).getList().get(j).getCwzy()) || "".equals(list.get(i).getList().get(j).getCwzx())) {
                    continue;
                }
                listLatLng.add(new LatLng(Double.parseDouble(list.get(i).getList().get(j).getCwzy()), Double.parseDouble(list.get(i).getList().get(j).getCwzx())));
                MyLog.showLog("MMM", list.get(i).getList().get(j).getCwzy() + " - " + list.get(i).getList().get(j).getCwzx());
                pushOverlay(new LatLng(Double.parseDouble(list.get(i).getList().get(j).getCwzy()),
                                Double.parseDouble(list.get(i).getList().get(j).getCwzx())),
                        list.get(i).getList().get(j).getCmc(),
                        list.get(i).getList().get(j).getYy(),
                        list.get(i).getList().get(j).getYx(),
                        list.get(i).getList().get(j).getSdt(),
                        list.get(i).getList().get(j).getTc());
        ...
        //        listLatLng.add(new LatLng(40.044451, 116.324313));
//        listLatLng.add(new LatLng(40.038631018592156, 116.32690741889955));
//        listLatLng.add(new LatLng(40.05895627620573, 116.31262436129091));
//        listLatLng.add(new LatLng(40.101009595285845, 116.30060503356741));
//        listLatLng.add(new LatLng(40.110384177399744, 116.32006233091353));
//
//        for (int i = 0; i < listLatLng.size(); i++) {
//            pushOverlay(new LatLng(listLatLng.get(i).latitude, listLatLng.get(i).longitude), "回龙观", "5", "5", "5", "5");
//            if (i == (listLatLng.size() - 1)) {
//                pushPoit(listLatLng.get(i).latitude, listLatLng.get(i).longitude);
//            }
//        }
...
//            mBaiduMap.addOverlay(new PolylineOptions().width(10).color(0xAAFF0000).points(listLatLng));
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                View view = getWindowView(bundle.getString("title"), bundle.getString("yuyi"), bundle.getString("yuxie"), bundle.getString("sdt"), bundle.getString("tc"));
                InfoWindow infoWindow = new InfoWindow(view, latLng, UtilsTools.dip2px(getActivity(), 150.0f));
    ...
    private View getWindowView(String title, String yuyi, String yuxie, String sdt, String tc) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_kucun, null);
        TextView tvTitle = (TextView) view.findViewById(R.id.tv_title);
        TextView tvYuyi = (TextView) view.findViewById(R.id.tv_yuyi);
        TextView tvYuxie = (TextView) view.findViewById(R.id.tv_yuxie);
        TextView tvSdt = (TextView) view.findViewById(R.id.tv_sdt);
        TextView tvTc = (TextView) view.findViewById(R.id.tv_tc);
        tvTitle.setText(title);
        tvYuyi.setText("雨衣：" + yuyi);
        tvYuxie.setText("雨鞋：" + yuxie);
        tvSdt.setText("手电筒：" + sdt);
        tvTc.setText("铁床：" + tc);
        return view;
    }

    public void getData() {
        NetWork.getKcwzlist("1", KuCunFragment.this);
    }

    private void pushData() {
//        list = new ArrayList<>();
//        List<KuCunFramentBean.DataBean.ListBeanX.ListBean> childList = new ArrayList<>();
//        childList.add(new KuCunFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new KuCunFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new KuCunFramentBean.DataBean.ListBeanX.ListBean());
//        childList.add(new KuCunFramentBean.DataBean.ListBeanX.ListBean());
//        List<KuCunFramentBean.DataBean.ListBeanX> groupList = new ArrayList<>();
//        groupList.add(new KuCunFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new KuCunFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new KuCunFramentBean.DataBean.ListBeanX(childList));
//        groupList.add(new KuCunFramentBean.DataBean.ListBeanX(childList));
