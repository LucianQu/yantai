...
import com.jsmy.pingshan.adapter.KuCunFragmentAdapter2;
...
public class KuCunFragment2 extends BaseFragment {
    @BindView(R.id.my_expand)
    RefreshRecyclerView myExpand;
    ...
    private KuCunFragmentAdapter2 adapter;
    private List<KunCunFrament2Bean.DataBean> list;
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_KCWZ_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, KunCunFrament2Bean.class).getData();
                    pushData();
                    markerPoit();
                } else {
//                    pushPoit(104.054616, 28.707722);
    ...
    private void initRecycer() {
        handler = new Handler();
        adapter = new KuCunFragmentAdapter2((DingWeiTongJiActivity) getActivity());
        myExpand.setSwipeRefreshColors(0xFF437845, 0xFFE44F98, 0xFF2FAC21);
        myExpand.setLayoutManager(new LinearLayoutManager(getActivity()));
...
//        option.setWifiValidTime(5*60*1000);
    ...
    private void pushOverlay(LatLng latLng, String xzq, String wz, String num) {
...
//        pushPoit(104.054616, 28.707722);
        ...
        for (int i = 0; i < list.size(); i++) {
            if ("".equals(list.get(i).getLttd2()) || "".equals(list.get(i).getLgtd2())) {
                continue;
            }
            listLatLng.add(new LatLng(Double.parseDouble(list.get(i).getLttd2()), Double.parseDouble(list.get(i).getLgtd2())));
            pushOverlay(new LatLng(Double.parseDouble(list.get(i).getLttd2()), Double.parseDouble(list.get(i).getLgtd2())),
                    list.get(i).getADNM(),
                    list.get(i).getWzmc(),
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                View view = getWindowView(bundle.getString("xzq"),
                        bundle.getString("wz"),
    ...
    private View getWindowView(String xzq, String wz, String num) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_kucun, null);
        TextView tvXzq = (TextView) view.findViewById(R.id.tv_xzq);
        TextView tvWz = (TextView) view.findViewById(R.id.tv_wz);
    ...
    public void getData() {
        NetWork.getKcwzlist("1", KuCunFragment2.this);
    }
