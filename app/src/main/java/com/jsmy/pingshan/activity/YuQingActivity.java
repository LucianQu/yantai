...
public class YuQingActivity extends BaseActivity {
    ...
    private List<YuQingBean.DataBean.ListBean> list;
    ...
    protected int getContenView() {
        return R.layout.activity_yu_qing;
    }

    @Override
    protected void initView() {
        handler = new Handler();
        adapter = new YuQingAdapter(this);
        mRecyclerView.setSwipeRefreshColors(0xFF437845, 0xFFE44F98, 0xFF2FAC21);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mRecyclerView.setAdapter(adapter);
        changeBtnColor(2);
        initBaiduMap();
        states = getResources().getStringArray(R.array.yuqing);
        ...
        mySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i) {
                    case 0:
                        NetWork.getYqlist("1", "10m", YuQingActivity.this);
                        break;
                    case 1:
                        NetWork.getYqlist("1", "30m", YuQingActivity.this);
                        break;
                    case 2:
                        NetWork.getYqlist("1", "1h", YuQingActivity.this);
                        break;
                    case 3:
                        NetWork.getYqlist("1", "2h", YuQingActivity.this);
                        break;
                    case 4:
                        NetWork.getYqlist("1", "3h", YuQingActivity.this);
                        break;
                    case 5:
                        NetWork.getYqlist("1", "6h", YuQingActivity.this);
                        break;
                    case 6:
                        NetWork.getYqlist("1", "12h", YuQingActivity.this);
                        break;
                    case 7:
                        NetWork.getYqlist("1", "24h", YuQingActivity.this);
                        break;
                }
    ...
    public void onSuccess(String type, String check, String code, String result, String msg) throws JSONException {
        switch (type) {
            case API.GET_YQ_LIST:
                if ("Y".equals(code)) {
                    list = gson.fromJson(result, YuQingBean.class).getData().getList();
                    getData();
                    markerPoit();
                } else {
...
//        option.setWifiValidTime(5*60*1000);
    ...
    private void pushOverlay(LatLng latLng, YuQingBean.DataBean.ListBean bean) {
