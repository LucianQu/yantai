...
public class YuAnCDataAdapter extends RecyclerView.Adapter<YuAnCDataAdapter.YuAnDataHolder> {
    private YuAnDataActivity context;
    private List<YuAnCDataBean.DataBean> list;

    public YuAnCDataAdapter(YuAnDataActivity context, List<YuAnCDataBean.DataBean> list) {
