...
public class ZhiHuiFragmentAdapter extends BaseExpandableListAdapter {

    private DingWeiTongJiActivity context;
    private List<ZhiHuiFramentBean.DataBean.ListBeanX> list;
    private LayoutInflater inflater;

    public ZhiHuiFragmentAdapter(DingWeiTongJiActivity context, List<ZhiHuiFramentBean.DataBean.ListBeanX> list) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        group.tvNum.setText(list.get(i).getZhrys());
        return view;
    }
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        child.tvNum.setText(list.get(i).getList().get(i1).getZhrys());
